...
public class Main {
  ...
  public static void quickSort(int[] arr,int low,int high){
      ...
      while (i<j) {
          //Look to the right first, in descending order to the left
          while (temp<=arr[j]&&i<j) {
              j--;
          }
          //Look to the left, in ascending order to the right
       ...
       //Finally exchange the base for a number in an equal position to i and j
        arr[low] = arr[i];
        arr[i] = temp;
       //Recursive calls to the left half of the array
       quickSort(arr, low, j-1);
       //Recursive calls to the right half of an array
